...
const { width, height } = Dimensions.get('window'); // Holt die echte Größe des Screens
...
const HomeScreen = () => {
  ...
  return (
    <ImageBackground
      ...
      resizeMode="cover" // Skaliert es proportional
    >
      <View style={styles.textWrapper}>
        <Text style={[styles.title, { color: theme.colors.black }, theme.typography.h1]}>Digital{'\n'}Cook{'\n'}Book</Text>
